...
_neural_optimizers_mnist = odict({
    ...
    'LSTM-ours': {
        'train_args': odict(n_epoch=50, n_train=20, n_valid=5, optim_it=100,
                           unroll=20, lr=0.007),
    },
})
...
_common_neural_args = {
    ...
    'LSTM-ours': odict(optim_module='neural_sparse_mask', preproc=True, out_mul=0.1),
}
...
_common_test_args_debug = odict(n_test=5, optim_it=200)
_common_test_args = odict(n_test=200, optim_it=1000)
